...
async function getTheme(id) {
  const { data } = await supabase
    ...
    .eq('id', id)
    .single()
  // Merge Supabase data over defaults so price/tag are always live
        ...
        <div style={{ width: '100%', maxWidth: '480px' }}>
          ...
          <div style={{ padding: '2rem', textAlign: 'center', background: styles.footerBg || '#0a0a1a' }}>
            ...
            <Link
              ...
              style={{ display: 'inline-block', background: vis.accent, color: '#2C1A0E', padding: '14px 32px', borderRadius: '100px', fontSize: '15px', fontWeight: 500, textDecoration: 'none' }}
            >
              Use this theme ✦
            </Link>

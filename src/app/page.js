...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '2rem 2rem 4rem', position: 'relative', overflow: 'hidden' }}>
